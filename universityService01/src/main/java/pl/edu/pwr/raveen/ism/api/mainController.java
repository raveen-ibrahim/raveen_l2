...
//    @PostMapping("/users")
//    public ResponseEntity<Void> usersIdPut(@RequestBody Integer id, Users users) {
...
//   
    ...
    @PutMapping("/users/{id}")
    public ResponseEntity<Void> usersIdPut(@PathVariable Integer id, @RequestBody Users users) {
        Users updatedUser = usersRepo.findById(id).orElse(null);
        if (updatedUser != null) {
    ...
    public ResponseEntity<Void> usersIdDelete(@PathVariable Integer id) {
